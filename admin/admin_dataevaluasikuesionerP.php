                        ...
                        <div class="content">
                            ...
                            <div class="module-body">                
                                <table class="table table-striped table-bordered table-condensed">
                                  ...
                                  $tampil3 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP003'");
                                  $tampil4 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP004'");
                                  $tampil5 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP005'");
                                  $tampil6 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP006'");
                                  $tampil7 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP007'");
                                  $tampil8 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP008'");
                                  $tampil9 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP009'");
                                  $tampil10 = mysql_query("select * from kuisoner_praktikan where id_kp = 'KP010'");
                                ...
                                if ($id != $r_id['total']){
                                    ...
                                    echo"
                                        <div class='control pull-right'>
                                            <a href='admin_dataevaluasikuesionerP.php?id_ksnilai=$id' type='submit' class='btn btn-success'>Next</a>  
                                        </div>
                                    "; 
                                }else{
                                    echo"
                                ...
                                if ($id != "2"){
                                    ...
                                    echo"
                                        <div class='control pull-left'>
                                            <a href='admin_dataevaluasikuesionerP.php?id_ksnilai=$id' type='submit' class='btn btn-success'>Prev</a>  
                                        </div>
                                    "; 
                                }else{
                                    echo"
