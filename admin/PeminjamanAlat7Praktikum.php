                                            ...
                                            while ($r = mysql_fetch_array($tampil)) {
                                                echo"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align=center><a href=query/PraktikumAlat7.php?serial_num=$r[serial_num]&kode_pinjam=$_GET[kode_pinjam]&tipe_pinjam=$_GET[tipe_pinjam]&id_peminjam=$_GET[id_peminjam]><button class='btn btn-danger'>Pilih</button></a></td>
                                                        </tr>
                                                    </form>";
                                            }
                                            ?>
