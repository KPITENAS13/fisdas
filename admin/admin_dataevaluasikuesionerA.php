                        ...
                        <div class="content">
                            ...
                            <div class="module-body">          
                                <table class="table table-striped table-bordered table-condensed">
                                  ...
                                  $id = $_GET['id_ksnilai'];
                                  include "koneksi.php";
                                  $tampil = mysql_query("select * from ks_nilaiasisten where id_ksnilai = $id");
                                  $tampil1 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA001'");
                                  $tampil2 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA002'");
                                  $tampil3 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA003'");
                                  $tampil4 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA004'");
                                  $tampil5 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA005'");
                                  $tampil6 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA006'");
                                  $tampil7 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA007'");
                                  $tampil8 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA008'");
                                  $tampil9 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA009'");
                                  $tampil10 = mysql_query("select * from kuisoner_asisten where id_ka = 'KA010'");
                                  ...
                                  $r6 = mysql_fetch_array($tampil6);
                                  $r7 = mysql_fetch_array($tampil7);
                                  $r8 = mysql_fetch_array($tampil8);
                                   ...
                                   echo"<tr>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                      <th colspan='6'>$r7[jenis_kuisoner]</th>
                                      <td rowspan='3'></td>
                                    </tr>
                                    <tr>
                                      <td scope='col'>$r7[kuisoner]</td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                      <th colspan='6'>$r9[jenis_kuisoner]</th>
                                      <td rowspan='2'></td>
                                    </tr>
                                    
                                    <tr>
                                      <td scope='col'>$r9[kuisoner]</td>
                                     ...
                                     <tr>
                                      <th colspan='6'>$r10[jenis_kuisoner]</th>
                                      <td rowspan='2'></td>
                                    </tr>
                                    
                                    <tr>
                                      <td scope='col'>$r10[kuisoner]</td>
                                ...
                                $tampil_id = mysql_query("select count(*) as total from ks_nilaiasisten");
                                $r_id = mysql_fetch_array($tampil_id);
                                if ($id != $r_id['total']){
                                    $id++;
                                    echo"
                                        <div class='control pull-right'>
                                            <a href='admin_dataevaluasikuesionerA.php?id_ksnilai=$id' type='submit' class='btn btn-success'>Next</a>  
                                        </div>
                                    "; 
                                }else{
                                    echo"
                                ...
                                if ($id != "2"){
                                    ...
                                    echo"
                                        <div class='control pull-left'>
                                            <a href='admin_dataevaluasikuesionerA.php?id_ksnilai=$id' type='submit' class='btn btn-success'>Prev</a>  
                                        </div>
                                    "; 
                                }else{
                                    echo"
